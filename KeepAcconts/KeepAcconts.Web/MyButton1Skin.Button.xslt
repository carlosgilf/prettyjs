...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.Button[@Attr.CustomStyle='MyButton1Skin']" mode="modContent">
  ...
  <xsl:template match="WC:Tags.Button[@Attr.CustomStyle='MyButton1Skin']" mode="modFrameCenterContent">
